...
format:
  html:
    ...
    message: false
    toc: true
    toc-title: "Iremos encontrar aqui:"
    toc-location: right
...
### 1 - Distribuição temporal da cobertura Vacinal da tríplice viral, Brasil e Regiões - 2000 a 2020.
...
### 2 - Distribuição da cobertura Vacinal da tríplice viral, Brasil e Regiões - 2000 a 2020.
...
### 3 - Distribuição da cobertura Vacinal da tríplice viral entre o Brasil e Regiões - 2000 a 2020.
...
### 4 - Distribuição Geográfica da cobertura vacinal pelo Brasil por grandes regiões por triênios 2000 a 2020.
